...
const vueuseHead_6154836f = defineNuxtPlugin((nuxtApp) => {
...
const plugin_47f60d3a = defineNuxtPlugin((nuxtApp) => {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<header${serverRenderer.exports.ssrRenderAttrs(_attrs)} data-v-003017f1><nav data-v-003017f1><a href="#inicio" data-v-003017f1> Inicio </a><a href="#proyectos" data-v-003017f1> Proyectos </a><a href="#fotos" data-v-003017f1> Fotos </a><a href="#contacto" data-v-003017f1> Contacto </a></nav></header>`);
}
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-003017f1"]]);
const Header = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": __nuxt_component_0
});
const _imports_0 = "/_nuxt/cata.jpeg";
const _sfc_main = {
  name: "IndexPage",
  components: { Header: __nuxt_component_0 }
};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_Header = __nuxt_component_0;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_Header, null, null, _parent));
  _push(`<div><section id="home"><div class="nombreYFoto"><div><h1> Catalina Rohde </h1><h2> Hace cine</h2></div><div class="flex-center"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} alt="" class="imagenCata"></div></div><p> En el transcurso de los dos a\xF1os de carrera tuve la oportunidad de realizar el montaje de un corto, tomar el rol de c\xE1mara durante la pandemia desde mi casa en otro y recientemente realice la producci\xF3n de un corto de cinco minutos como trabajo final de la materia Proyecto Audiovisual I. Aparte de la facultad edito reels para actores y videos de quince. </p></section><section id="proyectos"><h1 class="titulo"> Proyectos </h1></section><section id="fotos"><h1 class="titulo"> Fotos </h1></section><section id="contacto"><h1 class="titulo"> Contacto </h1></section></div><a href="#home" class="backTop"> Inicio </a></div>`);
}
